...
MagicPenguin::MagicPenguin(QWidget *parent) : QWidget(parent)
{

}

void MagicPenguin::paintEvent(QPaintEvent *)
{
    ...
    //左脚阴影
    drawRightFoot1(&painter);
    //左脚
    drawRightFoot2(&painter);
    ...
    //左眼睛眉毛
    drawLeftEye1(&painter);
    //左眼睛白色
    drawLeftEye2(&painter);
    //左眼睛眼珠
    drawLeftEye3(&painter);
    //左眼睛点缀
    drawLeftEye4(&painter);

    //右眼睛眉毛
    drawRightEye1(&painter);
    //右眼睛白色
    drawRightEye2(&painter);
    //右眼睛眼珠
    drawRightEye3(&painter);
    //右眼睛点缀
    drawRightEye4(&painter);
    ...
    //头部右侧点缀
    drawRightDot1(&painter);
    //右眼睛眉头
    drawRightDot2(&painter);
    //右耳朵
    drawRightDot3(&painter);
    //右耳朵孔
    drawRightDot4(&painter);
    //右手臂点缀
    drawRightDot5(&painter);

    //左手臂弧形
    drawLeftHandArc(&painter);
    //右手臂弧形
    drawRightHandArc(&painter);

    //肚子右侧点缀
    drawBeautify1(&painter);
    //肚子顶部点缀
    drawBeautify2(&painter);
    //肚子中间点缀
    drawBeautify3(&painter);

    //左脚阴影
    drawLeftFoot1(&painter);
    //左脚
    drawLeftFoot2(&painter);
}

void MagicPenguin::drawBelly1(QPainter *painter)
{
    //肚子上白色肚皮
    QPainterPath path;
    path.moveTo(120, 470);
...
void MagicPenguin::drawBelly2(QPainter *painter)
{
    //肚子右侧阴影边
    QPainterPath path;
...
void MagicPenguin::drawBelly3(QPainter *painter)
{
    //肚子左侧阴影边
    QPainterPath path;
...
void MagicPenguin::drawBelly4(QPainter *painter)
{
    //不知道干嘛的
    QPainterPath path;
...
void MagicPenguin::drawBelly5(QPainter *painter)
{
    //肚子上左侧领带
    QPainterPath path;
...
void MagicPenguin::drawBelly6(QPainter *painter)
{
    //肚子底部边缘
    QPainterPath path;
...
void MagicPenguin::drawShadow1(QPainter *painter)
{
    //肚子右下角手臂阴影
    QPainterPath path;
...
void MagicPenguin::drawShadow2(QPainter *painter)
{
    //屁股下阴影
    QPainterPath path;
...
void MagicPenguin::drawRightFoot1(QPainter *painter)
{
    //右脚阴影
    QPainterPath path;
...
void MagicPenguin::drawRightFoot2(QPainter *painter)
{
    //右脚
    QPainterPath path;
...
void MagicPenguin::drawCover1(QPainter *painter)
{
    //两只手臂和披肩
    QPainterPath path;
...
void MagicPenguin::drawCover2(QPainter *painter)
{
    //领带
    QPainterPath path;
...
void MagicPenguin::drawLeftEye1(QPainter *painter)
{
    //左眼睛眉毛
    QPainterPath path;
...
void MagicPenguin::drawLeftEye2(QPainter *painter)
{
    //左眼睛白色
    QPainterPath path;
...
void MagicPenguin::drawLeftEye3(QPainter *painter)
{
    //左眼睛眼珠
    QPainterPath path;
...
void MagicPenguin::drawLeftEye4(QPainter *painter)
{
    //左眼睛点缀
    QPainterPath path;
...
void MagicPenguin::drawRightEye1(QPainter *painter)
{
    //右眼睛眉毛
    QPainterPath path;
...
void MagicPenguin::drawRightEye2(QPainter *painter)
{
    //右眼睛白色
    QPainterPath path;
...
void MagicPenguin::drawRightEye3(QPainter *painter)
{
    //右眼睛眼珠
    QPainterPath path;
...
void MagicPenguin::drawRightEye4(QPainter *painter)
{
    //右眼睛点缀
    QPainterPath path;
...
void MagicPenguin::drawMouth1(QPainter *painter)
{
    //嘴巴阴影
    QPainterPath path;
...
void MagicPenguin::drawMouth2(QPainter *painter)
{
    //嘴巴
    QPainterPath path;
...
void MagicPenguin::drawMouth3(QPainter *painter)
{
    //嘴巴上的鼻孔
    QPainterPath path;
...
void MagicPenguin::drawRightDot1(QPainter *painter)
{
    //头部右侧点缀
    QPainterPath path;
...
void MagicPenguin::drawRightDot2(QPainter *painter)
{
    //右眼睛眉头
    QPainterPath path;
...
void MagicPenguin::drawRightDot3(QPainter *painter)
{
    //右耳朵
    QPainterPath path;
...
void MagicPenguin::drawRightDot4(QPainter *painter)
{
    //右耳朵孔
    QPainterPath path;
...
void MagicPenguin::drawRightDot5(QPainter *painter)
{
    //右手臂点缀
    QPainterPath path;
...
void MagicPenguin::drawLeftHandArc(QPainter *painter)
{
    //左手臂弧形
    QPainterPath path;
...
void MagicPenguin::drawRightHandArc(QPainter *painter)
{
    //右手臂弧形
    QPainterPath path;
...
void MagicPenguin::drawBeautify1(QPainter *painter)
{
    //肚子右侧点缀
    QPainterPath path;
...
void MagicPenguin::drawBeautify2(QPainter *painter)
{
    //肚子顶部点缀
    QPainterPath path;
...
void MagicPenguin::drawBeautify3(QPainter *painter)
{
    //肚子中间点缀
    QPainterPath path;
...
void MagicPenguin::drawLeftFoot1(QPainter *painter)
{
    //左脚阴影
    QPainterPath path;
...
void MagicPenguin::drawLeftFoot2(QPainter *painter)
{
    //左脚
    QPainterPath path;
...
QSize MagicPenguin::sizeHint() const
{
    return QSize(550, 550);
}

QSize MagicPenguin::minimumSizeHint() const
{
    return QSize(50, 50);
}
