...
FlightPFD::FlightPFD(QWidget *parent) : QGraphicsView(parent)
{
...
void FlightPFD::update()
{
    updateView();
}

void FlightPFD::setRoll(float roll)
{
    m_adi->setRoll(roll);
}

void FlightPFD::setPitch(float pitch)
{
    m_adi->setPitch(pitch);
}

void FlightPFD::setFlightPathMarker(float aoa, float sideslip, bool visible)
{
    m_adi->setFlightPathMarker(aoa, sideslip, visible);
}

void FlightPFD::setSlipSkid(float slipSkid)
{
    m_adi->setSlipSkid(slipSkid);
}

void FlightPFD::setTurnRate(float turnRate)
{
    m_adi->setTurnRate(turnRate);
}

void FlightPFD::setBarH(float barH, bool visible)
{
    m_adi->setBarH(barH, visible);
}

void FlightPFD::setBarV(float barV, bool visible)
{
    m_adi->setBarV(barV, visible);
}

void FlightPFD::setDotH(float dotH, bool visible)
{
    m_adi->setDotH(dotH, visible);
}

void FlightPFD::setDotV(float dotV, bool visible)
{
    m_adi->setDotV(dotV, visible);
}

void FlightPFD::setAltitude(float altitude)
{
    m_alt->setAltitude(altitude);
}

void FlightPFD::setPressure(float pressure, FlightPFD::PressureUnit pressureUnit)
{
    m_alt->setPressure(pressure, pressureUnit);
}

void FlightPFD::setAirspeed(float airspeed)
{
    m_asi->setAirspeed(airspeed);
}

void FlightPFD::setMachNo(float machNo)
{
    m_asi->setMachNo(machNo);
}

void FlightPFD::setHeading(float heading)
{
    m_hsi->setHeading(heading);
}

void FlightPFD::setClimbRate(float climbRate)
{
    m_vsi->setClimbRate(climbRate);
}

void FlightPFD::setIdent(const QString &ident, bool visible)
{
    m_ils->setIdentifier(ident, visible);
}

void FlightPFD::setDistance(float dist, bool visible)
{
    m_ils->setDistance(dist, visible);
}

QSize FlightPFD::sizeHint() const
{
    return QSize(300, 300);
}

QSize FlightPFD::minimumSizeHint() const
{
    return QSize(30, 30);
}

void FlightPFD::resizeEvent(QResizeEvent *pEvent)
{
...
void FlightPFD::init()
{
    ...
    m_itemBack = new QGraphicsSvgItem(":/svg/flight/pfd_back.svg");
    ...
    m_itemMask = new QGraphicsSvgItem(":/svg/flight/pfd_mask.svg");
...
void FlightPFD::reset()
{
    m_itemBack = 0;
    m_itemMask = 0;
}

void FlightPFD::updateView()
{
#ifndef noxmlsvg
    m_scaleX = (float)width()  / (float)m_originalWidth;
    m_scaleY = (float)height() / (float)m_originalHeight;
...
FlightPFD::ADI::ADI(QGraphicsScene *scene)
{
    m_scene = scene;
    ...
    m_originalAdiCtr = QPointF(150.0f, 125.0f);
    m_originalBackPos = QPointF(45.0f, -85.0f);
    m_originalLaddPos = QPointF(110.0f, -175.0f);
    m_originalRollPos = QPointF(45.0f, 20.0f);
    m_originalSlipPos = QPointF(145.5f, 68.5f);
    m_originalTurnPos = QPointF(142.5f, 206.0f);
    m_originalPathPos = QPointF(135.0f, 113.0f);
    m_originalBarHPos = QPointF(149.0f, 85.0f);
    m_originalBarVPos = QPointF(110.0f, 124.0f);
    m_originalDotHPos = QPointF(145.0f, 188.0f);
    m_originalDotVPos = QPointF(213.0f, 120.0f);
    m_originalScaleHPos = QPointF(0.0f, 0.0f);
    m_originalScaleVPos = QPointF(0.0f, 0.0f);
...
void FlightPFD::ADI::init(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
    ...
    m_itemBack = new QGraphicsSvgItem(":/svg/flight/pfd_adi_back.svg");
    m_itemBack->setCacheMode(QGraphicsItem::NoCache);
    m_itemBack->setZValue(m_backZ);
    m_itemBack->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    ...
    m_itemLadd = new QGraphicsSvgItem(":/svg/flight/pfd_adi_ladd.svg");
    ...
    m_itemRoll = new QGraphicsSvgItem(":/svg/flight/pfd_adi_roll.svg");
    ...
    m_itemSlip = new QGraphicsSvgItem(":/svg/flight/pfd_adi_slip.svg");
    ...
    m_itemTurn = new QGraphicsSvgItem(":/svg/flight/pfd_adi_turn.svg");
    ...
    m_itemPath = new QGraphicsSvgItem(":/svg/flight/pfd_adi_path.svg");
    ...
    m_itemMark = new QGraphicsSvgItem(":/svg/flight/pfd_adi_mark.svg");
    ...
    m_itemBarH = new QGraphicsSvgItem(":/svg/flight/pfd_adi_barh.svg");
    ...
    m_itemBarV = new QGraphicsSvgItem(":/svg/flight/pfd_adi_barv.svg");
    ...
    m_itemDotH = new QGraphicsSvgItem(":/svg/flight/pfd_adi_doth.svg");
    ...
    m_itemDotV = new QGraphicsSvgItem(":/svg/flight/pfd_adi_dotv.svg");
    ...
    m_itemScaleH = new QGraphicsSvgItem(":/svg/flight/pfd_adi_scaleh.svg");
    ...
    m_itemScaleV = new QGraphicsSvgItem(":/svg/flight/pfd_adi_scalev.svg");
    ...
    m_itemMask = new QGraphicsSvgItem(":/svg/flight/pfd_adi_mask.svg");
    m_itemMask->setCacheMode(QGraphicsItem::NoCache);
    m_itemMask->setZValue(m_maskZ);
    m_itemMask->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_scene->addItem(m_itemMask);
...
void FlightPFD::ADI::update(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
...
void FlightPFD::ADI::setRoll(float roll)
{
    m_roll = roll;
    if (m_roll < -180.0f) {
        m_roll = -180.0f;
    ...
    this->update(m_scaleX, m_scaleY);
}

void FlightPFD::ADI::setPitch(float pitch)
{
    m_pitch = pitch;
    if (m_pitch < -90.0f) {
        m_pitch = -90.0f;
...
void FlightPFD::ADI::setFlightPathMarker(float aoa, float sideslip, bool visible)
{
    m_angleOfAttack = aoa;
...
void FlightPFD::ADI::setSlipSkid(float slipSkid)
{
    m_slipSkid = slipSkid;
    if (m_slipSkid < -1.0f) {
        m_slipSkid = -1.0f;
...
void FlightPFD::ADI::setTurnRate(float turnRate)
{
    m_turnRate = turnRate;
    if (m_turnRate < -1.0f) {
        m_turnRate = -1.0f;
...
void FlightPFD::ADI::setBarH(float barH, bool visible)
{
    m_barH = barH;
    if (m_barH < -1.0f) {
        m_barH = -1.0f;
...
void FlightPFD::ADI::setBarV(float barV, bool visible)
{
    m_barV = barV;
    if (m_barV < -1.0f) {
        m_barV = -1.0f;
...
void FlightPFD::ADI::setDotH(float dotH, bool visible)
{
    m_dotH = dotH;
    if (m_dotH < -1.0f) {
        m_dotH = -1.0f;
...
void FlightPFD::ADI::setDotV(float dotV, bool visible)
{
    m_dotV = dotV;
    if (m_dotV < -1.0f) {
        m_dotV = -1.0f;
...
void FlightPFD::ADI::updateLadd(float delta, float sinRoll, float cosRoll)
{
#ifndef noxmlsvg
...
void FlightPFD::ADI::updateLaddBack(float delta, float sinRoll, float cosRoll)
{
#ifndef noxmlsvg
...
void FlightPFD::ADI::updateSlipSkid(float sinRoll, float cosRoll)
{
#ifndef noxmlsvg
...
void FlightPFD::ADI::updateTurnRate()
{
#ifndef noxmlsvg
...
void FlightPFD::ADI::updateFlightPath()
{
#ifndef noxmlsvg
    if (m_pathVisible) {
...
FlightPFD::ALT::ALT(QGraphicsScene *scene) :
    m_scene(scene),
...
void FlightPFD::ALT::init(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
    ...
    m_itemBack = new QGraphicsSvgItem(":/svg/flight/pfd_alt_back.svg");
    m_itemBack->setCacheMode(QGraphicsItem::NoCache);
    m_itemBack->setZValue(m_backZ);
    m_itemBack->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_itemBack->moveBy(m_scaleX * m_originalBackPos.x(), m_scaleY * m_originalBackPos.y());
    ...
    m_itemScale1 = new QGraphicsSvgItem(":/svg/flight/pfd_alt_scale.svg");
    ...
    m_itemScale2 = new QGraphicsSvgItem(":/svg/flight/pfd_alt_scale.svg");
    ...
    m_itemGround = new QGraphicsSvgItem(":/svg/flight/pfd_alt_ground.svg");
    ...
    m_itemFrame = new QGraphicsSvgItem(":/svg/flight/pfd_alt_frame.svg");
...
void FlightPFD::ALT::update(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
...
void FlightPFD::ALT::setAltitude(float altitude)
{
    m_altitude = altitude;
    if (m_altitude <     0.0f) {
        m_altitude =     0.0f;
...
void FlightPFD::ALT::setPressure(float pressure, int pressureUnit)
{
    m_pressure = pressure;
    if (m_pressure < 0.0f) {
        m_pressure = 0.0f;
...
void FlightPFD::ALT::updateAltitude()
{
#ifndef noxmlsvg
...
void FlightPFD::ALT::updatePressure()
{
#ifndef noxmlsvg
    if (m_pressureUnit == 0) {
...
void FlightPFD::ALT::updateScale()
{
#ifndef noxmlsvg
...
void FlightPFD::ALT::updateScaleLabels()
{
#ifndef noxmlsvg
...
FlightPFD::ASI::ASI(QGraphicsScene *scene) :
    m_scene(scene),
...
void FlightPFD::ASI::init(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
    ...
    m_itemBack = new QGraphicsSvgItem(":/svg/flight/pfd_asi_back.svg");
    m_itemBack->setCacheMode(QGraphicsItem::NoCache);
    m_itemBack->setZValue(m_backZ);
    m_itemBack->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_itemBack->moveBy(m_scaleX * m_originalBackPos.x(), m_scaleY * m_originalBackPos.y());
    ...
    m_itemScale1 = new QGraphicsSvgItem(":/svg/flight/pfd_asi_scale.svg");
    m_itemScale1->setCacheMode(QGraphicsItem::NoCache);
    m_itemScale1->setZValue(m_scaleZ);
    m_itemScale1->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_itemScale1->moveBy(m_scaleX * m_originalScale1Pos.x(), m_scaleY * m_originalScale1Pos.y());
    ...
    m_itemScale2 = new QGraphicsSvgItem(":/svg/flight/pfd_asi_scale.svg");
    m_itemScale2->setCacheMode(QGraphicsItem::NoCache);
    m_itemScale2->setZValue(m_scaleZ);
    m_itemScale2->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_itemScale2->moveBy(m_scaleX * m_originalScale2Pos.x(), m_scaleY * m_originalScale2Pos.y());
    ...
    m_itemFrame = new QGraphicsSvgItem(":/svg/flight/pfd_asi_frame.svg");
    m_itemFrame->setCacheMode(QGraphicsItem::NoCache);
    m_itemFrame->setZValue(m_frameZ);
    m_itemFrame->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_itemFrame->moveBy(m_scaleX * m_originalFramePos.x(), m_scaleY * m_originalFramePos.y());
...
void FlightPFD::ASI::update(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
...
void FlightPFD::ASI::setAirspeed(float airspeed)
{
    m_airspeed = airspeed;
    if (m_airspeed <    0.0f) {
        m_airspeed =    0.0f;
...
void FlightPFD::ASI::setMachNo(float machNo)
{
    m_machNo = machNo;
    if (m_machNo <  0.0f) {
        m_machNo =  0.0f;
...
void FlightPFD::ASI::updateAirspeed()
{
#ifndef noxmlsvg
...
void FlightPFD::ASI::updateScale()
{
...
void FlightPFD::ASI::updateScaleLabels()
{
...
FlightPFD::HSI::HSI(QGraphicsScene *scene) :
    m_scene(scene),
...
void FlightPFD::HSI::init(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
    ...
    m_itemBack = new QGraphicsSvgItem(":/svg/flight/pfd_hsi_back.svg");
    m_itemBack->setCacheMode(QGraphicsItem::NoCache);
    m_itemBack->setZValue(m_backZ);
    m_itemBack->setTransform(QTransform::fromScale(m_scaleX, m_scaleY), true);
    m_itemBack->moveBy(m_scaleX * m_originalBackPos.x(), m_scaleY * m_originalBackPos.y());
    ...
    m_itemFace = new QGraphicsSvgItem(":/svg/flight/pfd_hsi_face.svg");
    ...
    m_itemMarks = new QGraphicsSvgItem(":/svg/flight/pfd_hsi_marks.svg");
...
void FlightPFD::HSI::update(float scaleX, float scaleY)
{
    m_scaleX = scaleX;
    m_scaleY = scaleY;
...
void FlightPFD::HSI::setHeading(float heading)
{
    m_heading = heading;
...
void FlightPFD::HSI::updateHeading()
{
#ifndef noxmlsvg
...
FlightPFD::VSI::VSI(QGraphicsScene *scene) :
    m_scene(scene),
...
void FlightPFD::VSI::init(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
    ...
    m_itemScale = new QGraphicsSvgItem(":/svg/flight/pfd_vsi_scale.svg");
    ...
    m_itemArrow = new QGraphicsSvgItem(":/svg/flight/pfd_vsi_arrow.svg");
...
void FlightPFD::VSI::update(float scaleX, float scaleY)
{
    m_scaleX = scaleX;
    m_scaleY = scaleY;
    updateVSI();
...
void FlightPFD::VSI::setClimbRate(float climbRate)
{
...
FlightPFD::ILS::ILS(QGraphicsScene *scene) :
    m_scene(scene),
...
void FlightPFD::ILS::setIdentifier(const QString &ident, bool visible)
{
#ifndef noxmlsvg
    m_identifier = ident;
...
void FlightPFD::ILS::setDistance(float dist, bool visible)
{
#ifndef noxmlsvg
    m_distance = dist;
...
void FlightPFD::ILS::update(float scaleX, float scaleY)
{
    m_scaleX = scaleX;
    m_scaleY = scaleY;
...
void FlightPFD::ILS::init(float scaleX, float scaleY)
{
#ifndef noxmlsvg
    m_scaleX = scaleX;
    m_scaleY = scaleY;
