...
GaugeWeather::GaugeWeather(QWidget *parent) : QWidget(parent)
{
    ...
    innerRingNegativeColor = QColor(252, 81, 90);
    ...
    centerPixMapNegativeColor = QColor(252, 81, 90);
    centerPixMapPositiveColor = QColor(0, 254, 254);

    outerValueTextColor = QColor(34, 163, 169);
    innerNegativeValueTextColor = QColor(252, 81, 90);
    ...
    centerSvgPath = ":/svg/weather/weather-sunny.svg";
...
void GaugeWeather::drawValue(QPainter *painter)
{
    ...
    QString outerStrValue = QString("h: %1%").arg(QString::number(outerCurrValue, 'f', precision));
#if (QT_VERSION >= QT_VERSION_CHECK(5,11,0))
    double textWidth = fm.horizontalAdvance(outerStrValue);
#else
    double textWidth = fm.width(outerStrValue);
#endif
    QRectF titleRect(5, 0, textWidth, fm.height());
    ...
    QString innerStrValue = QString("t: %1%2℃").arg(innerDir).arg(QString::number(abs((int)innerCurrValue), 'f', precision));
#if (QT_VERSION >= QT_VERSION_CHECK(5,11,0))
    textWidth = fm.horizontalAdvance(innerStrValue);
#else
    textWidth = fm.width(innerStrValue);
#endif
    QRectF innerTitleRect(5, 0, textWidth, -fm.height());
...
int GaugeWeather::getPrecision() const
{
...
void GaugeWeather::setPrecision(int precision)
{
...
void GaugeWeather::setWeatherType(const WeatherType &weatherType)
{
    if (this->weatherType != weatherType) {
        ...
        switch (weatherType) {
            ...
            case WeatherType_RAINY:
                centerSvgPath = ":/svg/weather/weather-rainy.svg";
                break;
            case WeatherType_SNOWY:
                centerSvgPath = ":/svg/weather/weather-snowy.svg";
                break;
            case WeatherType_CLOUDY:
                centerSvgPath = ":/svg/weather/weather-cloudy.svg";
                break;
            case WeatherType_WINDY:
                centerSvgPath = ":/svg/weather/weather-windy.svg";
                break;
            case WeatherType_SNOWY_RAINY:
                centerSvgPath = ":/svg/weather/weather-snowy-rainy.svg";
                break;
            case WeatherType_HAIL:
                centerSvgPath = ":/svg/weather/weather-hail.svg";
                break;
            case WeatherType_LIGHTNING:
                centerSvgPath = ":/svg/weather/weather-lightning.svg";
                break;
            case WeatherType_FOG:
                centerSvgPath = ":/svg/weather/weather-fog.svg";
                break;
            case WeatherType_PARTLYCLOUDY:
                centerSvgPath = ":/svg/weather/weather-partlycloudy.svg";
                break;
            default:
                centerSvgPath = ":/svg/weather/weather-sunny.svg";
                break;
