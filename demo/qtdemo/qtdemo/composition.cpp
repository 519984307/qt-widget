...
CompositionWidget::CompositionWidget(QWidget *parent) : QWidget(parent)
{
    ...
    rbDestOver = new QRadioButton(tr("Destina Over"), modesGroup);
    ...
    rbColorDodge = new QRadioButton(tr("Color Dodg"), modesGroup);
    ...
    QLabel *circleColorLabel = new QLabel;
    circleColorLabel->setText(tr("Circle color"));
    QSlider *circleColorSlider = new QSlider(Qt::Horizontal);
    ...
    QLabel *circleAlphaLabel = new QLabel;
    circleAlphaLabel->setText(tr("Circle alpha"));
    QSlider *circleAlphaSlider = new QSlider(Qt::Horizontal);
    ...
    mainGroupLayout->addWidget(circleColorLabel);
    mainGroupLayout->addWidget(circleColorSlider);
    mainGroupLayout->addWidget(circleAlphaLabel);
    mainGroupLayout->addWidget(circleAlphaSlider);
    ...
    modesLayout->setContentsMargins(3, 3, 3, 3);
    modesLayout->setSpacing(3);
...
void CompositionRenderer::drawSource(QPainter &p)
{
    ...
    circle_gradient.setColorAt(0, color.lighter(150));
    circle_gradient.setColorAt(0.5, color);
    circle_gradient.setColorAt(1, color.darker(150));
