    ...
    : ArthurFrame(parent)
{
    ...
    m_pixmap = QPixmap(":/image/liuyifei3.jpg");
...
void XFormView::wheelEvent(QWheelEvent *e)
{
    ...
    m_scale += e->angleDelta().y() / double(600);
#else
...
XFormWidget::XFormWidget(QWidget *parent) : QWidget(parent), textEditor(new QLineEdit)
{
    ...
    QLabel *shearLabel = new QLabel;
    shearLabel->setText(tr("Shear"));
    ...
    QRadioButton *vectorType = new QRadioButton(mainGroup);
    QRadioButton *pixmapType = new QRadioButton(mainGroup);
    QRadioButton *textType = new QRadioButton(mainGroup);
    ...
    mainGroupLayout->addWidget(rotateLabel);
    mainGroupLayout->addWidget(rotateSlider);
    mainGroupLayout->addWidget(scaleLabel);
    mainGroupLayout->addWidget(scaleSlider);
    mainGroupLayout->addWidget(shearLabel);
    mainGroupLayout->addWidget(shearSlider);

    mainGroupLayout->addWidget(vectorType);
    mainGroupLayout->addWidget(pixmapType);
    mainGroupLayout->addWidget(textType);
    mainGroupLayout->addSpacing(4);
    mainGroupLayout->addWidget(textEditor);
    ...
    textEditor->setText("feiyangqingyun");
