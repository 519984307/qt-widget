...
public: CompositionWidget(QWidget *parent = 0);
...
public:
    ...
    int circleColor() const {
        return m_circle_hue;
    }
    int circleAlpha() const {
        return m_circle_alpha;
    }
...
public slots:
    ...
    void setCircleAlpha(int alpha) {
        m_circle_alpha = alpha;
        this->update();
    }
    void setCircleColor(int hue) {
        m_circle_hue = hue;
        this->update();
    }
