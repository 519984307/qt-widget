...
public:
    ...
    double realPenWidth() const {
        return m_penWidth;
    }
    void setRealPenWidth(double penWidth) {
        m_penWidth = penWidth;
        this->update();
    }
...
{
    Q_OBJECT
public: PathStrokeControls(QWidget *parent, PathStrokeRenderer *renderer, bool smallScreen);
...
{
    Q_OBJECT
public: PathStrokeWidget(QWidget *parent = 0, bool smallScreen = false);
