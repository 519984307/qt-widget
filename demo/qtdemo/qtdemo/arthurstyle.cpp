                                ...
                                QPainter *painter, const QWidget *widget) const
{
    ...
    case PE_IndicatorRadioButton:
        if (const QStyleOptionButton *button = qstyleoption_cast<const QStyleOptionButton *>(option)) {
            ...
            if (button->state & State_Sunken) {
                radio = cached(":/image/qtdemo/radiobutton-on.png");
            } else if (button->state & State_On) {
                radio = cached(":/image/qtdemo/radiobutton_on.png");
            } else {
                radio = cached(":/image/qtdemo/radiobutton_off.png");
            }
    ...
    case PE_PanelButtonCommand:
        if (const QStyleOptionButton *button = qstyleoption_cast<const QStyleOptionButton *>(option)) {
            ...
            if (down) {
                left = cached(":/image/qtdemo/button_pressed_cap_left.png");
                right = cached(":/image/qtdemo/button_pressed_cap_right.png");
                mid = cached(":/image/qtdemo/button_pressed_stretch.png");
            } else {
                left = cached(":/image/qtdemo/button_normal_cap_left.png");
                right = cached(":/image/qtdemo/button_normal_cap_right.png");
                mid = cached(":/image/qtdemo/button_normal_stretch.png");
            }
    ...
    case PE_FrameGroupBox:
        if (const QStyleOptionFrame * group
            ...
            QPixmap titleStretch = cached(":/image/qtdemo/title_stretch.png");
            QPixmap topLeft = cached(":/image/qtdemo/groupframe_topleft.png");
            QPixmap topRight = cached(":/image/qtdemo/groupframe_topright.png");
            QPixmap bottomLeft = cached(":/image/qtdemo/groupframe_bottom_left.png");
            QPixmap bottomRight = cached(":/image/qtdemo/groupframe_bottom_right.png");
            QPixmap leftStretch = cached(":/image/qtdemo/groupframe_left_stretch.png");
            QPixmap topStretch = cached(":/image/qtdemo/groupframe_top_stretch.png");
            QPixmap rightStretch = cached(":/image/qtdemo/groupframe_right_stretch.png");
            QPixmap bottomStretch = cached(":/image/qtdemo/groupframe_bottom_stretch.png");
    ...
    case CC_Slider:
        if (const QStyleOptionSlider *slider = qstyleoption_cast<const QStyleOptionSlider *>(option)) {
            ...
            if ((option->subControls & SC_SliderGroove) && groove.isValid()) {
                QPixmap grv = cached(":/image/qtdemo/slider_bar.png");
                painter->drawPixmap(QRect(groove.x() + 5, groove.y(),
                                          groove.width() - 10, grv.height()),
                                    grv);
            }
            if ((option->subControls & SC_SliderHandle) && handle.isValid()) {
                QPixmap hndl = cached(":/image/qtdemo/slider_thumb_on.png");
    ...
    case CC_GroupBox:
        if (const QStyleOptionGroupBox * groupBox
            ...
            if (groupBox->subControls & SC_GroupBoxLabel) {
                ...
                QPixmap titleLeft = cached(":/image/qtdemo/title_cap_left.png");
                QPixmap titleRight = cached(":/image/qtdemo/title_cap_right.png");
                QPixmap titleStretch = cached(":/image/qtdemo/title_stretch.png");
