...
PathDeformControls::PathDeformControls(QWidget *parent, PathDeformRenderer *renderer, bool smallScreen) : QWidget(parent)
{
    m_renderer = renderer;
...
void PathDeformControls::layoutForDesktop()
{
    ...
    QLabel *deformLabel = new QLabel;
    deformLabel->setText(tr("Deformation"));
    QSlider *deformSlider = new QSlider(Qt::Horizontal);
    ...
    QPushButton *animateButton = new QPushButton;
    animateButton->setText(tr("Animated"));
    animateButton->setCheckable(true);

    QPushButton *showSourceButton = new QPushButton;
    showSourceButton->setText(tr("Show Source"));

#ifdef QT_OPENGL_SUPPORT
    QPushButton *enableOpenGLButton = new QPushButton;
    ...
    QPushButton *whatsThisButton = new QPushButton;
    whatsThisButton->setText(tr("What's This?"));
    whatsThisButton->setCheckable(true);
    mainGroup->setFixedWidth(180);

    QVBoxLayout *mainGroupLayout = new QVBoxLayout(mainGroup);
    mainGroupLayout->addWidget(radiusLabel);
    mainGroupLayout->addWidget(radiusSlider);
    mainGroupLayout->addWidget(deformLabel);
    mainGroupLayout->addWidget(deformSlider);
    mainGroupLayout->addWidget(fontSizeLabel);
    mainGroupLayout->addWidget(fontSizeSlider);
    mainGroupLayout->addWidget(textLabel);
    mainGroupLayout->addWidget(textInput);
...
void PathDeformControls::layoutForSmallScreen()
{
    ...
    deformSlider->setValue(80);
    fontSizeSlider->setValue(120);
    radiusSlider->setValue(qMin(deskGeometry.width(), deskGeometry.height()) / 5);
