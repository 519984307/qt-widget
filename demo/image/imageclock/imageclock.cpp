...
void ImageClock::setClockStyle(const ClockStyle &clockStyle)
{
    if (this->clockStyle != clockStyle) {
        ...
        clockBg = QImage(QString(":/image/imageclock/clock_%1.png").arg(imageName));
        clockHour = QImage(QString(":/image/imageclock/clock_%1_h.png").arg(imageName));
        clockMin = QImage(QString(":/image/imageclock/clock_%1_m.png").arg(imageName));
        clockSec = QImage(QString(":/image/imageclock/clock_%1_s.png").arg(imageName));
        clockDot = QImage(QString(":/image/imageclock/clock_%1_dot.png").arg(imageName));
        clockHighlights = QImage(QString(":/image/imageclock/clock_%1_highlights.png").arg(imageName));
        this->update();
    }
}
