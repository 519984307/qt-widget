...
#include "frmcodecount.h"
#include "ui_frmcodecount.h"
#include "qfile.h"
...
frmCodeCount::frmCodeCount(QWidget *parent) : QWidget(parent), ui(new Ui::frmCodeCount)
{
    ui->setupUi(this);
    this->initForm();
    on_btnClear_clicked();
...
frmCodeCount::~frmCodeCount()
{
    delete ui;
}

void frmCodeCount::initForm()
{
...
bool frmCodeCount::checkFile(const QString &fileName)
{
...
void frmCodeCount::countCode(const QString &filePath)
{
    QDir dir(filePath);
...
void frmCodeCount::countCode(const QStringList &files)
{
    int lineCode;
    int lineBlank;
    int lineNotes;
...
void frmCodeCount::countCode(const QString &fileName, int &lineCode, int &lineBlank, int &lineNotes)
{
...
void frmCodeCount::on_btnOpenFile_clicked()
{
...
void frmCodeCount::on_btnOpenPath_clicked()
{
...
void frmCodeCount::on_btnClear_clicked()
{
